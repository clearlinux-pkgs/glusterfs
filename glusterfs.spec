...
%prep
%setup -q -n glusterfs-7.2
cd %{_builddir}/glusterfs-7.2
...
cp %{_builddir}/glusterfs-7.2/COPYING-LGPLV3 %{buildroot}/usr/share/package-licenses/glusterfs/f45ee1c765646813b442ca58de72e20a64a7ddba
cp %{_builddir}/glusterfs-7.2/contrib/fuse-lib/COPYING.LIB %{buildroot}/usr/share/package-licenses/glusterfs/44f7289042b71631acac29b2f143330d2da2479e
cp %{_builddir}/glusterfs-7.2/contrib/fuse-util/COPYING %{buildroot}/usr/share/package-licenses/glusterfs/dfac199a7539a404407098a2541b9482279f690d
cp %{_builddir}/glusterfs-7.2/contrib/macfuse/COPYING.txt %{buildroot}/usr/share/package-licenses/glusterfs/ead3bd339cb09fc31a9b956ec13105db9e5f4d19
%make_install
